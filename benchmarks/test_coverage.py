...
SKIPPED_OPS: dict[str, str] = {
    ...
    "aten::mm.out": _OUT,
    "aten::mul.out": _OUT,
    "aten::mvlgamma.out": _OUT,
    "aten::nan_to_num.out": _OUT,
    "aten::ne.Scalar_out": _OUT,
    "aten::ne.Tensor_out": _OUT,
    "aten::neg.out": _OUT,
    "aten::polygamma.out": _OUT,
    "aten::reciprocal.out": _OUT,
    "aten::relu.out": _OUT,
    "aten::round.decimals_out": _OUT,
    "aten::round.out": _OUT,
    "aten::rsqrt.out": _OUT,
    ...
    "aten::sign.out": _OUT,
    "aten::signbit.out": _OUT,
    "aten::silu.out": _OUT,
    "aten::sin.out": _OUT,
    "aten::sinc.out": _OUT,
    "aten::sinh.out": _OUT,
    "aten::special_airy_ai.out": _OUT,
    "aten::special_bessel_j0.out": _OUT,
    "aten::special_bessel_j1.out": _OUT,
    "aten::special_bessel_y0.out": _OUT,
    "aten::special_bessel_y1.out": _OUT,
    "aten::special_entr.out": _OUT,
    "aten::special_erfcx.out": _OUT,
    "aten::special_i0e.out": _OUT,
    "aten::special_i1.out": _OUT,
    "aten::special_i1e.out": _OUT,
    "aten::special_log_ndtr.out": _OUT,
    "aten::special_modified_bessel_i0.out": _OUT,
    "aten::special_modified_bessel_i1.out": _OUT,
    "aten::special_modified_bessel_k0.out": _OUT,
    "aten::special_modified_bessel_k1.out": _OUT,
    "aten::special_ndtri.out": _OUT,
    "aten::special_scaled_modified_bessel_k0.out": _OUT,
    "aten::special_scaled_modified_bessel_k1.out": _OUT,
    "aten::special_spherical_bessel_j0.out": _OUT,
    "aten::sub.out": _OUT,
    "aten::trunc.out": _OUT,
