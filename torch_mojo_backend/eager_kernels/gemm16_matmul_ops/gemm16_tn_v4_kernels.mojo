...
# launch size and the carve cannot drift.  Zero in the static regime --
# `_v4_dyn_smem_arg` drops it there (gemm16_nn_v4_kernels.mojo).
@always_inline
...
def _v4_enqueue_direct_m128n192(
    ...
    if multi_wave:
        ctx.enqueue_function[_v4_tn_direct_m128n192_s3g16](
            ...
            grid_dim=(grid_x,),
            block_dim=(_V4_THREADS,),
            shared_mem_bytes=_v4_dyn_smem_arg[DYN_SMEM_S3](),
        ...
        ctx.enqueue_function[_v4_tn_direct_m128n192_s4](
            ...
            grid_dim=(grid_x,),
            block_dim=(_V4_THREADS,),
            shared_mem_bytes=_v4_dyn_smem_arg[DYN_SMEM_S4](),
