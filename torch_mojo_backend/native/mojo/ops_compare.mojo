...
def register_compare(lib: Lib) raises:
    impl[op_eq_tensor](lib, "eq.Tensor")
    impl[op_eq_tensor_out](lib, "eq.Tensor_out")
    impl[op_eq_scalar](lib, "eq.Scalar")
    impl[op_eq_scalar_out](lib, "eq.Scalar_out")
    impl[op_ne_tensor](lib, "ne.Tensor")
    impl[op_ne_tensor_out](lib, "ne.Tensor_out")
    impl[op_ne_scalar](lib, "ne.Scalar")
    impl[op_ne_scalar_out](lib, "ne.Scalar_out")
    impl[op_lt_tensor](lib, "lt.Tensor")
    impl[op_lt_tensor_out](lib, "lt.Tensor_out")
    impl[op_lt_scalar](lib, "lt.Scalar")
    impl[op_lt_scalar_out](lib, "lt.Scalar_out")
    impl[op_le_tensor](lib, "le.Tensor")
    impl[op_le_tensor_out](lib, "le.Tensor_out")
    impl[op_le_scalar](lib, "le.Scalar")
    impl[op_le_scalar_out](lib, "le.Scalar_out")
    impl[op_gt_tensor](lib, "gt.Tensor")
    impl[op_gt_tensor_out](lib, "gt.Tensor_out")
    impl[op_gt_scalar](lib, "gt.Scalar")
    impl[op_gt_scalar_out](lib, "gt.Scalar_out")
    impl[op_ge_tensor](lib, "ge.Tensor")
    impl[op_ge_tensor_out](lib, "ge.Tensor_out")
    impl[op_ge_scalar](lib, "ge.Scalar")
    impl[op_ge_scalar_out](lib, "ge.Scalar_out")
    impl[op_isin_tensor_tensor](lib, "isin.Tensor_Tensor")
    impl[op_isin_tensor_tensor_out](lib, "isin.Tensor_Tensor_out")
    impl[op_where_self](lib, "where.self")
    impl[op_masked_fill_scalar](lib, "masked_fill.Scalar")
    impl[op_masked_fill_scalar_out](lib, "masked_fill.Scalar_out")
    impl[op_masked_fill_tensor](lib, "masked_fill.Tensor")
    impl[op_masked_fill_tensor_out](lib, "masked_fill.Tensor_out")
    impl[op_masked_fill__scalar](lib, "masked_fill_.Scalar")
    impl[op_masked_fill__tensor](lib, "masked_fill_.Tensor")
    impl[op_searchsorted_tensor](lib, "searchsorted.Tensor")
    impl[op_searchsorted_tensor_out](lib, "searchsorted.Tensor_out")
    impl[op_searchsorted_scalar](lib, "searchsorted.Scalar")
    impl[op_searchsorted_scalar_out](lib, "searchsorted.Scalar_out")
    impl[op_bucketize_tensor](lib, "bucketize.Tensor")
    impl[op_bucketize_tensor_out](lib, "bucketize.Tensor_out")
    impl[op_bucketize_scalar](lib, "bucketize.Scalar")
    impl[op_bucketize_scalar_out](lib, "bucketize.Scalar_out")
