...
d64 instantiation in fa4.mojo — dense causal, the strided-QKV ABI,
...
point in fa4.mojo instantiates either at ANY head_dim — there is
...
comment in fwd_kernel.mojo) already fall back to the pre-existing,
