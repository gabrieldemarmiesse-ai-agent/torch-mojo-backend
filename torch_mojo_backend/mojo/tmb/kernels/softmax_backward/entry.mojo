...
# Same architecture as tmb/kernels/loss/entry.mojo / embedding_backward.mojo: the
...
from tmb.kernels.softmax_backward.kernels import enqueue_log_softmax_backward
