...
Use a CUDA-enabled torch environment and pass MOJOCCL_LIBRARY from the main
checkout's build. Gloo only distributes the NCCL unique ID; collectives call
the C ABI directly because the mojo process group uses its own comm stream.
"""
